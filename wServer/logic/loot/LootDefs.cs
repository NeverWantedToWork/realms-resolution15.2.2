...
namespace wServer.logic.loot
{
    ...
    public class TierLoot : ILootDef
    {
        ...
        public static readonly int[] AbilityT = {4, 5, 11, 12, 13, 15, 16, 18, 19, 20, 21, 22, 23, 25, 29};
    ...
    public static class LootTemplates
    {
        ...
        public static ILootDef[] FabledItemsLoot1()
            ...
            return new ILootDef[]
            {
                ...
                new OnlyOne(
                    new ItemLoot("Kismet Seal", 0.2),
                    new ItemLoot("Soundpiercer Shuriken", 0.2),
                    new ItemLoot("Doomgrazer", 0.2),
                    new ItemLoot("Age of Zol", 0.2),
                    new ItemLoot("Wrath of Aldragine", 0.2),
                    new ItemLoot("Bane of the Vision", 0.2),
                    new ItemLoot("Spirit of the Heart", 0.2),
                    new ItemLoot("The Grand Finale", 0.2),
                    new ItemLoot("Merit of Rebellion", 0.2),
                    new ItemLoot("Enigma Wand", 0.2),
                    new ItemLoot("Spear of the Unforgiven", 0.2)
                ),
                //You have a 10% chance to get attack or wisdom eon
                new OnlyOne(
                    new ItemLoot("Attack Eon", 0.15),
                    new ItemLoot("Wisdom Eon", 0.15)
                ),
