        ...
        private _ Larry = () => Behav()
            .Init("Larry Gigsman, the Superhuman",
                new State(
                    ...
                    new State("taunt",
                        new Taunt("You can't possibly beat me..the almight Larry Gigsman!"),
                    ...
                    new State("taunt3",
                        ...
                        new ChatTransition("Start", "Yes", "yes")
                        )
                      ),
                    new State(
                        new SetAltTexture(0),
                ...
                new MostDamagers(3,
                    new ItemLoot("Sexy GoodDeal Package", 1.00)
                ),
                new Threshold(0.025,
