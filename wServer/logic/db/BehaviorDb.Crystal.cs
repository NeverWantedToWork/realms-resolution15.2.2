        ...
        private _ Crystal = () => Behav()
            ...
            .Init("Crystal Prisoner",
                ...
                new Threshold(0.05,
                    ...
                    new ItemLoot("Crystal Sword", 0.026),
        ...
        .Init("Large Sor Crystal",
                    ...
                    new State("Mush2",
                      ...
                      new State("Mush3",
                       ...
                       new State("die",
                        new DropPortalOnDeath("The Dojo Portal", 20),
                        new Aoe(3.5, true, 100, 200, true, 0x00FF00),
                ...
                new Threshold(0.05,
                    new ItemLoot("Sor Crystal", 0.75),
                    new ItemLoot("Upsurge Sphere", 0.15)
                    )
            )
            ;
    }
