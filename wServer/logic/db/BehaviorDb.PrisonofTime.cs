    ...
    partial class BehaviorDb
    {
        ...
        .Init("Galleom of Time",
                new State(
                    ...
                    new State("Fight2",
                        new ReturnToSpawn(speed: 1, once: true),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                    ...
                    new State("Blocker",
                        ...
                        new TossObject("Timelord Blocker", 3, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Timelord Blocker", 3, 45, coolDown: 9999999, randomToss: false),
                        new TossObject("Timelord Blocker", 3, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Timelord Blocker", 3, 135, coolDown: 9999999, randomToss: false),
                        new TossObject("Timelord Blocker", 3, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Timelord Blocker", 3, 225, coolDown: 9999999, randomToss: false),
                        new TossObject("Timelord Blocker", 3, 270, coolDown: 9999999, randomToss: false),
                        new TossObject("Timelord Blocker", 3, 315, coolDown: 9999999, randomToss: false),
                    ...
                    new State("Rage",
                        ...
                        new SpecificHeal(1, 1000, "Self", coolDown: 2000),
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Mayhem Lockbox", 0.45),
                    new ItemLoot("Mayhem Lockbox Key", 0.5),
                    new ItemLoot("Sunshine Lockbox", 0.45),
                    new ItemLoot("Sunshine Lockbox Key", 0.5),
                    new ItemLoot("Wig Week Lockbox", 0.45),
                    new ItemLoot("Wig Week Lockbox Key", 0.5)
                )
            )
            ;
    }
