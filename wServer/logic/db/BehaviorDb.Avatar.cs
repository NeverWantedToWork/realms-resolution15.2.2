        ...
        private _ Avatar = () => Behav()
            .Init("shtrs Defense System",
                ...
                new Threshold(0.05,
                    ...
                    new ItemLoot("Blade of Offerings", 0.005),
                    new ItemLoot("Cultist Armor", 0.005),
                    new ItemLoot("Mysterious Stone", 0.03),
                    new ItemLoot("Shield of the Phantom", 0.007),
                    new ItemLoot("Sunshine Lockbox", 0.06),
                    new ItemLoot("Sunshine Lockbox Key", 0.065)
