...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Corrupted Stone Giant C",
            new State(
                new Grenade(2, 40, 5, coolDown: 3000),
                new TossObject("Servant of Darkness", 5, coolDown: 4000, coolDownOffset: 2000, randomToss: true),
                new SpecificHeal(8, 3000, "Self", coolDown: 2000),
                new TransformOnDeath("Headless Stone Giant", 1, 1, 1),
                new Orbit(0.3, 3, 20),
                new State("fight1",
        ...
        .Init("Cube of Zol",
                new State(
                    new Wander(0.8),
                    new Shoot(8, 3, shootAngle: 10, coolDown: 750)
                    ),
                new Threshold(0.5,
        ...
        .Init("Cleric of Zol",
                new State(
                    new Wander(0.6),
                    new SpecificHeal(8, 500, "Zol", coolDown: 4000),
                    new Shoot(12, count: 1, projectileIndex: 0, coolDown: 2000)
                    ),
                new Threshold(0.5,
                    new ItemLoot("Tome of Divine Favor", 0.01)
                    )
            )
        .Init("Zol Sorcerer",
            new State(
                ...
                new State("fight2",
                     new Shoot(10, count: 4, shootAngle: 26, projectileIndex: 1, coolDown: 1000),
                     new TimedTransition(4000, "fight1")
                    ),
				new State("fight4",
            ...
            new State(
                new State("fight1",
                    new Prioritize(
                     ...
                     new TossObject("Zol Mine", range: 7, coolDown: new Cooldown(5200, 2000), coolDownOffset: 1800),
        ...
        .Init("Aldragine TaskMaster 1",
            new State(
                new DropPortalOnDeath("Sincryer's Gate Portal", 100, PortalDespawnTimeSec: 180),
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("idle",
        ...
        .Init("AH The Sincryer",
                new State(
                    new DropPortalOnDeath("The Nontridus Portal", 100, PortalDespawnTimeSec: 180),
                    ...
                    new State("go3",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new TossObject("Zol Bomber", 6, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 6, 45, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 6, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 6, 135, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 6, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 6, 225, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 6, 270, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 6, 315, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 9, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 9, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 9, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Zol Bomber", 9, 270, coolDown: 9999999, randomToss: false),
					...
					new State("swag21",
                        ...
                        new Grenade(4, 80, coolDown: 3000),
                        new Prioritize(
					...
					new State("basic3",
                        ...
                        new TossObject("AH Big Purple Slime", range: 4, coolDown: 2500, randomToss: true),
        ...
        .Init("AH Loot Chest 1",
                ...
                new ItemLoot("Onrane", 0.08),
                new ItemLoot("Sexy GoodDeal Package", 0.045),
                new ItemLoot("The Stronghold Key", 0.06),
                new ItemLoot("Gold Cache", 0.04),
                ...
                new EggLoot(EggRarity.Legendary, 0.025)
                )
            )
        ...
        .Init("AH Loot Chest 3",
                ...
                new TierLoot(13, ItemType.Armor, 0.06),
                new TierLoot(5, ItemType.Ring, 0.06),
                new ItemLoot("Onrane", 0.15),
                new ItemLoot("Sexy GoodDeal Package", 0.08),
                new ItemLoot("The Stronghold Key", 0.07),
                new ItemLoot("Gold Cache", 0.04),
                new ItemLoot("Greater Potion of Life", 1),
                new ItemLoot("Greater Potion of Defense", 1),
        ...
        .Init("AH Loot Chest 4",
                ...
                new ItemLoot("Sexy GoodDeal Package", 0.06),
        ...
        .Init("AH Secret Chest",
                ...
                new ItemLoot("Onrane", 1),
                new ItemLoot("Dark Matter", 0.5),
                new ItemLoot("Revulsion Sphere", 0.25)
        ...
        .Init("Construct of Zol",
            new State(
                ...
                new State("1",
                     ...
                     new SpecificHeal(10, 1500, "ZolBoss", coolDown: new Cooldown(4000, 1500))
                    ),
                new State("explode",
        ...
        .Init("AH The Vision of Aldragine",
                new State(
                    new DropPortalOnDeath("Core of the Hideout Portal", 100, PortalDespawnTimeSec: 180),
                    new HpLessTransition(0.12, "spookded"),
                    new State("default",
						new ConditionalEffect(ConditionEffectIndex.Invincible),
                    ...
                    new State("SummonConstructs",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new TossObject("Construct of Zol", 6, 270, coolDown: 9999999, randomToss: false),
                        new TossObject("Construct of Zol", 6, 90, coolDown: 9999999, randomToss: false),
                   ...
                   new State(
                    ...
                    new State("nextfam2",
                        new SpecificHeal(1, 20000, "Self", coolDown: 2500),
                        new Taunt("Your essence is mine!"),
                        new TossObject("Demon of the Dark", 9, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Demon of the Dark", 9, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Demon of the Dark", 9, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Demon of the Dark", 9, 270, coolDown: 9999999, randomToss: false),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Flash(0xFFFFFF, 1, 2),
        ...
        .Init("AH The Heart",
                ...
                new State(
                    ...
                    new State("Burst1",
                        ...
                        new InvisiToss("Zol Sorcerer", 5, 45, coolDown: 9999999),
                        new InvisiToss("Zol Sorcerer", 5, 90, coolDown: 9999999),
                        new InvisiToss("Zol Sorcerer", 5, 135, coolDown: 9999999),
                        new InvisiToss("Zol Sorcerer", 5, 180, coolDown: 9999999),
                        new InvisiToss("Zol Sorcerer", 5, 225, coolDown: 9999999),
                        new InvisiToss("Zol Sorcerer", 5, 270, coolDown: 9999999),
                        new InvisiToss("Zol Sorcerer", 5, 315, coolDown: 9999999),
                        //Start Spawning Servants shortly after
                        new InvisiToss("Servant of Darkness", 10, 45, coolDown: 40000, coolDownOffset: 2600),
                        new InvisiToss("Servant of Darkness", 10, 135, coolDown: 40000, coolDownOffset: 2600),
                        new InvisiToss("Servant of Darkness", 10, 225, coolDown: 40000, coolDownOffset: 2600),
                        new InvisiToss("Servant of Darkness", 10, 315, coolDown: 40000, coolDownOffset: 2600),
                        //Start Spawning Brutes
                        new InvisiToss("Brute of the Hideout", 4, 45, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 135, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 225, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 315, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 45, coolDown: 15000, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 135, coolDown: 15000, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 225, coolDown: 15000, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 315, coolDown: 15000, coolDownOffset: 1400),
                        // Spawn demons
                        new InvisiToss("Demon of the Dark", 10, 45, coolDown: 25000, coolDownOffset: 2600),
                        new InvisiToss("Demon of the Dark", 10, 135, coolDown: 25000, coolDownOffset: 2600),
                        new InvisiToss("Demon of the Dark", 10, 225, coolDown: 25000, coolDownOffset: 2600),
                        new InvisiToss("Demon of the Dark", 10, 315, coolDown: 25000, coolDownOffset: 2600),
					...
					new State("Burst2",
                        ...
                        new InvisiToss("Zol Sorcerer", 5, 315, coolDown: 9999999),
                        //Start Spawning Servants shortly after
                        new InvisiToss("Corrupted Stone Giant B", 10, 45, coolDown: 40000, coolDownOffset: 2600),
                        new InvisiToss("Corrupted Stone Giant B", 10, 135, coolDown: 40000, coolDownOffset: 2600),
                        new InvisiToss("Corrupted Stone Giant B", 10, 225, coolDown: 40000, coolDownOffset: 2600),
                        new InvisiToss("Corrupted Stone Giant B", 10, 315, coolDown: 40000, coolDownOffset: 2600),
                        //Start Spawning Brutes
                        new InvisiToss("Brute of the Hideout", 4, 45, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 135, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 225, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Brute of the Hideout", 4, 315, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Niolru", 4, 45, coolDown: 15000, coolDownOffset: 4000),
                        new InvisiToss("Niolru", 4, 135, coolDown: 15000, coolDownOffset: 4000),
                        new InvisiToss("Niolru", 4, 225, coolDown: 15000, coolDownOffset: 4000),
                        new InvisiToss("Niolru", 4, 315, coolDown: 15000, coolDownOffset: 4000),
                        // Spawn demons
                        new InvisiToss("Demon of the Dark", 10, 45, coolDown: 25000, coolDownOffset: 2600),
                        new InvisiToss("Demon of the Dark", 10, 135, coolDown: 25000, coolDownOffset: 2600),
                        new InvisiToss("Demon of the Dark", 10, 225, coolDown: 25000, coolDownOffset: 2600),
					...
					new State("FinalBurst",
                        ...
                        new InvisiToss("Corrupted Stone Giant B", 10, 315, coolDown: 40000, coolDownOffset: 2600),
                        //Start Spawning Brutes
                        new InvisiToss("AH Big Purple Slime", 4, 45, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("AH Big Purple Slime", 4, 135, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("AH Big Purple Slime", 4, 225, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("AH Big Purple Slime", 4, 315, coolDown: 12500, coolDownOffset: 1400),
                        new InvisiToss("Niolru", 4, 45, coolDown: 15000, coolDownOffset: 4000),
                        new InvisiToss("Niolru", 4, 135, coolDown: 15000, coolDownOffset: 4000),
                        new InvisiToss("Niolru", 4, 225, coolDown: 15000, coolDownOffset: 4000),
                        new InvisiToss("Niolru", 4, 315, coolDown: 15000, coolDownOffset: 4000),
                    ...
                    new State("Failed",
                        new Taunt("THERE IS NO REMORSE. YOU ARE BANISHED.", "YOU HAVE NOT BEEN FORGIVEN. REIGN.", "WE DO NOT FORGIVE. YOU WON'T ADVANCE. YOU WILL BE LEFT TO BE DOOMED."),
						new Flash(0xFF0000, 1, 3),
                        new TimedTransition(3200, "Failure")
                        ),
                    new State("Done",
						//Delete all spooks
						new RemoveEntity(999, "Giant Cube of Zol"),
                    ...
                    new State("Success",
						new DropPortalOnDeath("Keeping of Aldragine Portal", 100, PortalDespawnTimeSec: 180),
        ...
        .Init("AH Aldragine",
                new State(
                    ...
                    new State("BestShot",
						new ReturnToSpawn(true, 1),
						new SpecificHeal(1, 30000, "Self", coolDown: 99999),
						new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    ...
                    new State("GoToLeft",
						new MoveTo(2, 14, speed: 1, isMapPosition: true, once: true),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
					...
					new State(
						new TimedTransition(12000, "Failed"),
					new State("KillStones2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new SpecificHeal(1, 1500, "Self", coolDown: 3000),
                        new Flash(0x0F00F0, 1, 2),
					...
					new State("BeamofDeath",
						...
						new SpecificHeal(1, 40000, "Self", coolDown: 99999),
                        new Prioritize(
                             new StayCloseToSpawn(0.5, 3),
                             new Wander(0.05)
                             ),
					...
					new State("GoToRight",
						new MoveTo(24, 14, speed: 1, isMapPosition: true, once: true),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    ...
                    new State("Vulnerable1",
						...
						new ConditionalEffect(ConditionEffectIndex.Armored),
                        new SpecificHeal(1, 8000, "Self", coolDown: 2500),
					...
					new State("Vulnerable",
						new MoveTo(13, 9, speed: 1, isMapPosition: true, once: true),
					...
					new State("Nope",
						...
						new SpecificHeal(1, 20000, "Self", coolDown: 2500),
						new ConditionalEffect(ConditionEffectIndex.Invulnerable),
						new TossObject("Servant of Darkness", 2, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Servant of Darkness", 2, 45, coolDown: 9999999, randomToss: false),
                        new TossObject("Servant of Darkness", 2, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Servant of Darkness", 2, 135, coolDown: 9999999, randomToss: false),
                        new TossObject("Servant of Darkness", 2, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Servant of Darkness", 2, 225, coolDown: 9999999, randomToss: false),
                        new TossObject("Servant of Darkness", 2, 270, coolDown: 9999999, randomToss: false),
                        new TossObject("Servant of Darkness", 2, 315, coolDown: 9999999, randomToss: false),
					...
					new State("Success",
						...
						new DropPortalOnDeath("Treasure of Zol Portal", 50, PortalDespawnTimeSec: 120),
