        ...
        .Init("Frozen Shield",
                new State(
                    ...
                    new State("Circle",
                        ...
                        new SpecificHeal(4, 25, "Bergelmir", coolDown: 1800),
        ...
        .Init("Frozen Sphere Turret",
                new State(
                    ...
                    new State("Active3",
                        ...
                        new Reproduce("Frozen Warrior 1", densityMax: 1, densityRadius: 16, spawnRadius: 2, coolDown: new Cooldown(3600, 800)),
                        new Reproduce("Frozen Warrior 2", densityMax: 1, densityRadius: 16, spawnRadius: 2, coolDown: new Cooldown(3600, 800))
                        ),
                    new State("Active4",
                        new Shoot(10, count: 2, shootAngle: 16, projectileIndex: 0, coolDown: 1200),
                        new Reproduce("Frozen Warrior 1", densityMax: 1, densityRadius: 16, spawnRadius: 2, coolDown: new Cooldown(4000, 800)),
                        new Reproduce("Frozen Warrior 2", densityMax: 1, densityRadius: 16, spawnRadius: 2, coolDown: new Cooldown(4000, 800))
                        )
                    )
                )
        .Init("Bergelmir, the Frost Guardian",
                new State(
                    ...
                    new State("ShotgunPhase1",
                        ...
                        new TossObject("Frozen Soul", 4, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Frozen Soul", 4, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Frozen Soul", 4, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Frozen Soul", 4, 270, coolDown: 9999999, randomToss: false),
                        //Extra Souls
                        new TossObject("Frozen Soul", 4, 180, coolDown: 9999999, randomToss: false, coolDownOffset: 1000),
                        new TossObject("Frozen Soul", 4, 90, coolDown: 9999999, randomToss: false, coolDownOffset: 1000),
                    ...
                    new State("WanderandAttack1",
                        ...
                        new TossObject("Frozen Soul", 4, 180, coolDown: 9999999, randomToss: false, coolDownOffset: 5000),
                        new TossObject("Frozen Soul", 4, 90, coolDown: 9999999, randomToss: false, coolDownOffset: 5000),
                    ...
                    new State("flashwarning",
                        ...
                        new TossObject("Frozen Soul", 4, 180, coolDown: 9999999, randomToss: false, coolDownOffset: 1000),
                        new TossObject("Frozen Soul", 4, 90, coolDown: 9999999, randomToss: false, coolDownOffset: 1000),
                        new TossObject("Frozen Soul", 4, 270, coolDown: 9999999, randomToss: false, coolDownOffset: 1000),
                        new TossObject("Frozen Soul", 4, 0, coolDown: 9999999, randomToss: false, coolDownOffset: 1000),
                    ...
                    new State("RushCrnrTR1",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(35, 9, speed: 1.6, isMapPosition: true, once: true),
                    ...
                    new State("RushCrnrTL1",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(10, 9, speed: 1.6, isMapPosition: true, once: true),
                    ...
                    new State("RushCrnrBL1",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(10, 23, speed: 1.6, isMapPosition: true, once: true),
                    ...
                    new State("RushCrnrBR1",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(35, 23, speed: 1.6, isMapPosition: true, once: true),
                    ...
                    new State("HealingPhaseBef",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new MoveTo(23, 16, speed: 1, isMapPosition: true, once: true),
                    ...
                    new State("HealStart",
                        ...
                        new SpecificHeal(1, 1000, "Self", coolDown: 800),
                    ...
                    new State("ProtectionPhase",
                        ...
                        new TossObject("Frozen Shield", 3, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Frozen Shield", 3, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Frozen Shield", 3, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Frozen Shield", 3, 270, coolDown: 9999999, randomToss: false),
