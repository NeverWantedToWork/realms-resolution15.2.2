        ...
        private _ Pumpkin = () => Behav()
            .Init("Pumpkin King of Peril",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Wig Week Lockbox Key", 0.06),
                    new ItemLoot("Wig Week Lockbox", 0.065),
                    new ItemLoot("Asiimov Lockbox Key", 0.06),
                    new ItemLoot("Asiimov Lockbox", 0.065),
                    new ItemLoot("Overgrowth Lockbox Key", 0.06),
                    new ItemLoot("Overgrowth Lockbox", 0.065),
                    new ItemLoot("Mayhem Lockbox Key", 0.06),
                    new ItemLoot("Mayhem Lockbox", 0.065),
                    new ItemLoot("Sunshine Lockbox Key", 0.06),
                    new ItemLoot("Sunshine Lockbox", 0.065),
                    new ItemLoot("Sexy GoodDeal Package", 0.07)
