...
namespace wServer.logic
{
    ...
    {
        private _ IceChamberMain = () => Behav()
        .Init("Frost Wyrm",
                new State(
                    new Prioritize(
        ...
        .Init("Ice Cleric",
                new State(
                    ...
                    new SpecificHeal(5, 100, "IceCleric", coolDown: 2000),
                ...
                new State(
                  new State("FightAndGuard",
                    ...
                    new State("Spawn",
                     ...
                     new Shoot(10, count: 4, shootAngle: 24, projectileIndex: 1, coolDown: 1750),
                     new Reproduce("Warrior of Frost", densityMax: 1, densityRadius: 16, spawnRadius: 2, coolDown: new Cooldown(4600, 1000)),
                     new Reproduce("Knight of Frost", densityMax: 1, densityRadius: 16, spawnRadius: 2, coolDown: new Cooldown(4600, 1000)),
