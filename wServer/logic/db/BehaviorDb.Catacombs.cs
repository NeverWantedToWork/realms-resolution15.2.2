...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Corrupted Flames of Fate",
                new State(
                    ...
                    new State("trailofdeath",
                        new SpecificHeal(1, 500, "Self", coolDown: 1250),
                         new Prioritize(
                    ...
                    new State("ringblam2",
                        ...
                        new SpecificHeal(1, 1500, "Self", coolDown: 500),
                        new Follow(0.5, 8, 1),
                ...
                new MostDamagers(1,
                    ...
                    new ItemLoot("Potion of Strength", 1.0),
                    new ItemLoot("Potion of Agility", 1.0)
                ),
                new Threshold(0.025,
                    ...
                    new ItemLoot("Gold Cache", 0.03),
                    new ItemLoot("Asiimov Lockbox Key", 0.055),
                    new ItemLoot("Asiimov Lockbox", 0.05),
                    new ItemLoot("Overgrowth Lockbox", 0.055),
                    new ItemLoot("Overgrowth Lockbox Key", 0.05),
                    new ItemLoot("Sunshine Lockbox", 0.06),
                    new ItemLoot("Sunshine Lockbox Key", 0.04)
         ...
         .Init("Guardian of the Catacombs",
             new State(
                   ...
                   new State("Heal",
                      ...
                      new SpecificHeal(1, 75, "Self", coolDown: 1000),
        ...
        .Init("Treasure Statue of the Catacombs",
                                ...
                                new ItemLoot("Potion of Strength", 0.3),
        ...
        .Init("Doomages",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Asiimov Lockbox Key", 0.045),
                    new ItemLoot("Asiimov Lockbox", 0.05),
                    new ItemLoot("Overgrowth Lockbox", 0.045),
                    new ItemLoot("Overgrowth Lockbox Key", 0.05),
                    new ItemLoot("Wig Week Lockbox", 0.05),
                    new ItemLoot("Wig Week Lockbox Key", 0.04)
        ...
        .Init("Tridorno",
                new State(
                    ...
                    new State("WanderandShoot",
                     ...
                     new State("RunandGun",
                        ...
                        new SpecificHeal(1, 100, "Self", coolDown: 1500),
                     ...
                     new State("LightningFam",
                         new SpecificHeal(1, 62500, "Self", coolDown: 999999),
                        new Sequence(
                            new Timed(3000,
                                new Prioritize(
                     ...
                     new State("ReturnToSpawn",
                        ...
                        new ReturnToSpawn(once: true, speed: 0.75),
                     ...
                     new State("spodermen",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new TossObject("Arena Spider", 8, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 10, 45, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 7, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 5, 135, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 12, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 8, 225, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 6, 270, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 8, 315, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 10, 260, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 13, 160, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 12, 70, coolDown: 9999999, randomToss: false),
                        new TossObject("Arena Spider", 12, 30, coolDown: 9999999, randomToss: false),
                   ...
                   new State("CheckSpoders",
                       new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        ...
                        new SpecificHeal(1, 250, "Self", coolDown: 2000),
                        new Shoot(10, count: 6, projectileIndex: 5, coolDown: 5000),
                        new TossObject("Catacombs Turret 1", 8, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("Catacombs Turret 1", 8, 45, coolDown: 9999999, randomToss: false),
                        new TossObject("Catacombs Turret 1", 8, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("Catacombs Turret 1", 8, 135, coolDown: 9999999, randomToss: false),
                        new TossObject("Catacombs Turret 1", 8, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("Catacombs Turret 1", 8, 225, coolDown: 9999999, randomToss: false),
                        new TossObject("Catacombs Turret 1", 8, 270, coolDown: 9999999, randomToss: false),
                        new TossObject("Catacombs Turret 1", 8, 315, coolDown: 9999999, randomToss: false),
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Gold Cache", 0.032),
                    new ItemLoot("Daring Windrage Robe", 0.04),
                    new ItemLoot("Skull of Glowing Plagues", 0.035),
                    new ItemLoot("Ring of Pestilence", 0.025),
                    new ItemLoot("Asiimov Lockbox Key", 0.065),
                    new ItemLoot("Asiimov Lockbox", 0.055),
                    new ItemLoot("Overgrowth Lockbox", 0.065),
                    new ItemLoot("Overgrowth Lockbox Key", 0.065),
                    new ItemLoot("Wig Week Lockbox", 0.065),
                    new ItemLoot("Wig Week Lockbox Key", 0.044),
                    new ItemLoot("Sunshine Lockbox", 0.055),
                    new ItemLoot("Sunshine Lockbox Key", 0.045)
