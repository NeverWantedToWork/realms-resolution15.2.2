    ...
    partial class BehaviorDb
    {
        private _ Mountain = () => Behav()
            .Init("White Demon",
                ...
                new TierLoot(3, ItemType.Ability, 0.04),
                    ...
                    new ItemLoot("Potion of Attack", 0.026),
            ...
            new State(
                ...
                new State("spawnWasp",
                     ...
                     new InvisiToss("Wasp God", 4, 90, coolDown: 9999),
        ...
        .Init("Wasp God",
                ...
                new DropPortalOnDeath("The Hive Portal", 25),
                    new Prioritize(
                        new Orbit(0.3, 4, target: "Wasp Group Anchor", acquireRange: 8),
                        new Wander(0.4)
                        ),
        ...
        .Init("Thunder God",
                new State(
                    new DropPortalOnDeath("Stormy Palace Portal", 45),
                    new Prioritize(
                        new Follow(0.5, range: 7),
                        new Wander(0.4)
                        ),
                    new Shoot(10, 3, 10, coolDown: 5000)
                    ),
                ...
                new TierLoot(3, ItemType.Ability, 0.042),
                    ...
                    new TierLoot(9, ItemType.Armor, 0.03),
                    new ItemLoot("Potion of Defense", 0.022),
            ...
            .Init("Arena Headless Horseman",
                new State(
                    ...
                    new DropPortalOnDeath("Haunted Cemetery Portal", 69)
                ),
                new Threshold(0.18,
            ...
            .Init("Sprite Child",
                new State(
                    ...
                    new DropPortalOnDeath("Glowing Portal", 22)
                    )
            )
            .Init("Medusa",
                new State(
                ...
                new TierLoot(3, ItemType.Ability, 0.04),
                    ...
                    new TierLoot(9, ItemType.Armor, 0.03),
                    new ItemLoot("Potion of Speed", 0.022),
                     new EggLoot(EggRarity.Common, 0.04),
                    new EggLoot(EggRarity.Uncommon, 0.022)
                    )
            )
            .Init("Ent God",
                ...
                new TierLoot(4, ItemType.Ability, 0.02),
                    ...
                    new TierLoot(9, ItemType.Armor, 0.03),
                    new ItemLoot("Potion of Defense", 0.027),
                    new EggLoot(EggRarity.Common, 0.04),
                    new EggLoot(EggRarity.Uncommon, 0.022)
                    )
            )
            ...
            .Init("Beholder",
                new State(
                    new DropPortalOnDeath("Tunnel of Pain Portal", 2),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
                ...
                new TierLoot(3, ItemType.Ability, 0.04),
                    ...
                    new ItemLoot("Potion of Defense", 0.026),
                     new EggLoot(EggRarity.Common, 0.04),
                    new EggLoot(EggRarity.Uncommon, 0.022)
                    )
            )
            .Init("Flying Brain",
                new State(
                    ...
                    new DropPortalOnDeath("Mad Lab Portal", 14)
                    ),
                new TierLoot(6, ItemType.Weapon, 0.07),
                new Threshold(0.18,
                ...
                new TierLoot(3, ItemType.Ability, 0.04),
                    ...
                    new TierLoot(9, ItemType.Armor, 0.03),
                    new ItemLoot("Potion of Attack", 0.028),
                     new EggLoot(EggRarity.Common, 0.04),
                    new EggLoot(EggRarity.Uncommon, 0.022)
                    )
            )
            ...
            .Init("Ghost God",
                ...
                new TierLoot(3, ItemType.Ability, 0.04),
                    ...
                    new TierLoot(9, ItemType.Armor, 0.03),
                    new ItemLoot("Potion of Speed", 0.026),
                    new EggLoot(EggRarity.Common, 0.1),
                    new EggLoot(EggRarity.Uncommon, 0.05)
                    )
            )
            ...
            .Init("Steel Bot",
                ...
                new TierLoot(7, ItemType.Weapon, 0.03),
                new TierLoot(7, ItemType.Armor, 0.05),
                new TierLoot(8, ItemType.Armor, 0.03),
                new TierLoot(3, ItemType.Ring, 0.020),
                new TierLoot(4, ItemType.Ring, 0.010),
            ...
            .Init("Lucky Djinn",
                ...
                new TierLoot(4, ItemType.Ability, 0.03),
                    ...
                    new ItemLoot("Potion of Speed", 0.024),
                    new EggLoot(EggRarity.Common, 0.1),
                    new EggLoot(EggRarity.Uncommon, 0.05)
                    )
            )
