    ...
    partial class BehaviorDb
    {
              ...
              .Init("Shrine of Urios",
                  new State(
                    ...
                    new State("JacobKills",
                        new Heal(5, "Urios", coolDown: 2100),
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                 ...
                 .Init("Summoner of Elements",
                  new State(
                   ...
                   new PlayerWithinTransition(5, "Enemies")
                    ...
                    new State("Enemies",
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new TossObject("Summoner Water Elemental", 2, 0, coolDown: 9999999, randomToss: false),
                    new TossObject("Summoner Air Elemental", 2, 90, coolDown: 9999999, randomToss: false),
                    new TossObject("Summoner Fire Elemental", 2, 180, coolDown: 9999999, randomToss: false),
                    new TossObject("Summoner Earth Elemental", 2, 270, coolDown: 9999999, randomToss: false),
        ...
        //Swag
              ...
              .Init("Urios Test Chest",
                ...
                new ItemLoot("Elemental Tome", 0.02),
                new ItemLoot("Wand of Elemental Sanctuary", 0.02)
                )
            );
