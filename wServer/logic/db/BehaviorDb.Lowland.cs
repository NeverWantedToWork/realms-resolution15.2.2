        ...
        private _ Lowland = () => Behav()
            .Init("Hobbit Mage",
                new State(
                    ...
                    new Reproduce("Hobbit Archer", densityRadius: 20, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(9000, 3000)),
                    new Reproduce("Hobbit Rogue", densityRadius: 20, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(8000, 3000))
                    ),
            ...
            .Init("Undead Hobbit Mage",
                new State(
                    ...
                    new Reproduce("Undead Hobbit Archer", densityRadius: 20, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(9000, 3000)),
                    new Reproduce("Undead Hobbit Rogue", densityRadius: 20, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(10000, 2000))
                    ),
            ...
            .Init("Elf Wizard",
                new State(
                    ...
                    new Reproduce("Elf Archer", densityRadius: 20, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(8000, 5000)),
                    new Reproduce("Elf Swordsman", densityMax: 18, spawnRadius: 1, coolDown: new Cooldown(10000, 4000)),
                    new Reproduce("Elf Mage", densityRadius: 20, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(9600, 5000))
                    ),
            ...
            .Init("Goblin Mage",
                new State(
                    new DropPortalOnDeath("Forest Maze Portal", 65),
                    new State("unharmed",
                    ...
                    new Reproduce("Goblin Rogue", densityRadius: 20, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(9000, 2000)),
                    new Reproduce("Goblin Warrior", densityRadius: 18, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(10000, 2000))
                    ),
                new TierLoot(3, ItemType.Weapon, 0.3),
                new TierLoot(3, ItemType.Armor, 0.3),
            ...
            .Init("Sandsman King",
                new State(
                    ...
                    new Reproduce("Sandsman Archer", densityRadius: 18, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(9000, 5000)),
                    new Reproduce("Sandsman Sorcerer", densityRadius: 17, densityMax: 3, spawnRadius: 1, coolDown: new Cooldown(10000, 5000))
                    ),
                new TierLoot(3, ItemType.Weapon, 0.3),
                new TierLoot(3, ItemType.Armor, 0.3),
                new TierLoot(1, ItemType.Ring, 0.11),
