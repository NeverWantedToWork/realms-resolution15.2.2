        ...
        .Init("AB The Dark Sorcerer",
                new State(
                    ...
                    new State("HealABit",
                        ...
                        new SpecificHeal(1, 2000, "Self", coolDown: 1000),
                   ...
                   new State(
                       new Reproduce("Wraith of Sorrow", densityMax: 2, spawnRadius: 1, coolDown: 4400),
                    new State("BigShot",
                        new Prioritize(
                            new Follow(0.6),
                            new Wander(0.2)
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Dirk of Benevolence", 0.03),
                    new ItemLoot("Bow of the Lonesome Wraith", 0.03),
                    new ItemLoot("Wand Of The Prohibited Fire", 0.03),
                    new ItemLoot("Robe of the Wonder Aquamarine", 0.03),
                    new ItemLoot("Wand of Fractured Time", 0.03),
                    new ItemLoot("Revivement Lockbox", 0.45),
                    new ItemLoot("Revivement Lockbox Key", 0.45),
