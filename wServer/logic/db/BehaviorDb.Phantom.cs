        ...
        private _ Phantom = () => Behav()
            .Init("Elemental Phantom",
                new State(
                    ...
                    new DropPortalOnDeath("Elemental Ruins Portal", 75),
                    new State("default",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Elemental Relic", 0.02),
                    new ItemLoot("Asiimov Lockbox", 0.048),
                    new ItemLoot("Asiimov Lockbox Key", 0.0482)
                )
            );
