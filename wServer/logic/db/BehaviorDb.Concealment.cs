        ...
        private _ Concealment = () => Behav()
            .Init("The Dreadnought",
                ...
                new Threshold(0.022,
                    ...
                    new ItemLoot("Overgrowth Lockbox", 0.0475),
                    new ItemLoot("Overgrowth Lockbox Key", 0.05),
                    new ItemLoot("Dreadplate Sword", 0.01),
                    new ItemLoot("Bow of Dreadful Reign", 0.01)
                )
            )
          ...
          .Init("Mystical Basilisk",
                new State(
                  new Grenade(2, 200, range: 5, coolDown: 3000),
                  new State("fight",
                     new Wander(0.5),                     
                ...
                new State("swag2",
                    new SpecificHeal(1, 500, "Self", coolDown: 1000),
                     new Follow(1, 8, 1),
           ...
           .Init("Treasure Basilisk",
                ...
                new State("fight2",
                    new Taunt(1.00, "You want treasure, but I want your corpse.", "You shouldn't have found me. You'll now be found dead.", "I'd like to think you're just another snack.", "Pepper will go good with your flesh.", "The crunch of your bones will be quite satisfying to hear.", "I will rip your head off and drink the blood out of your body.", "Leave."),
                     new ConditionalEffect(ConditionEffectIndex.Armored),
                     new SpecificHeal(1, 300, "Self", coolDown: 500),
                ...
                new Threshold(0.15,
                    ...
                    new ItemLoot("Potion of Strength", 1.00),
                    new ItemLoot("Overgrowth Lockbox", 0.05),
                    new ItemLoot("Overgrowth Lockbox Key", 0.055),
                    new ItemLoot("Lorespire Robe", 0.015),
                    new ItemLoot("Bow of Dreadful Reign", 0.015)
                )
