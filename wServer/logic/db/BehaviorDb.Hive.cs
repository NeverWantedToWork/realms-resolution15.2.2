...
namespace wServer.logic
{
    partial class BehaviorDb
    {
            ...
            .Init("Polerste, the Fierce Wasp",
                new State(
                    ...
                    new State("CircleHive",
                        ...
                        new Reproduce("Hive Wasp Warrior 3", densityMax: 4, spawnRadius: 1, coolDown: 1000),
                    ...
                    new State("runaway",
                        ...
                        new Reproduce("Hive Wasp Warrior 3", densityMax: 6, spawnRadius: 1, coolDown: 1000),
        ...
        .Init("Hive Spawner",
            new State(
                new ConditionalEffect(ConditionEffectIndex.StasisImmune),
                        new ConditionalEffect(ConditionEffectIndex.StunImmune),
                new State("throwwasp",
                     new Reproduce("Hive Wasp Warrior 3", densityMax: 1, spawnRadius: 1, coolDown: 2000)
                    )
                ),
                new Threshold(0.025,
        ...
        .Init("Hive Spawner Boss",
                    ...
                    new State("throwboss",
                        new TossObject("Polerste, the Fierce Wasp", 5, 270, coolDown: 5200, randomToss: false),
                        new TimedTransition(2000, "Block")
                        )
                      ),
                    new State(
                        new TossObject("Honey Bomb", 7, coolDown: new Cooldown(2600, 1600), randomToss: false),
                    new State("Block",
                        new SpecificHeal(1, 100, "Self", coolDown: 1200),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
