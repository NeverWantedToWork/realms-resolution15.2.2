    ...
    partial class BehaviorDb
    {
        ...
        .Init("GP Test Taskmaster",
            new State(
                ...
                new State("activate",
                    ...
                    new DropPortalOnDeath("The Regolith Portal", 100, PortalDespawnTimeSec: 180),
                     new Suicide()
                    )
                )
            )
        .Init("The Overseer",
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Mayhem Lockbox Key", 0.45),
                    new ItemLoot("Asiimov Lockbox", 0.45),
                    new ItemLoot("Neon Annihilation Lockbox", 0.45),
                    new ItemLoot("Neon Annihilation Lockbox Key", 0.45),
                    new ItemLoot("Asiimov Lockbox Key", 0.45)
                )
            )
        .Init("The Alien King",
                new State(
                    ...
                    new State(
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new SpecificHeal(1, 100, "Self", coolDown: 6000),
                    ...
                    new State("Shotty1",
                        ...
                        new TossObject("Alien UFO", 6, coolDown: 2000, randomToss: true),
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Blade of the Nightbringer", 0.035),
                    new ItemLoot("Phantasm Sword", 0.035),
                    new ItemLoot("Doge's Pendant", 0.035),
                    new ItemLoot("Overgrowth Lockbox", 0.45),
                    new ItemLoot("Overgrowth Lockbox Key", 0.45),
                    new ItemLoot("Mayhem Lockbox", 0.45),
                    new ItemLoot("Mayhem Lockbox Key", 0.45),
                    new ItemLoot("Neon Annihilation Lockbox", 0.45),
                    new ItemLoot("Neon Annihilation Lockbox Key", 0.45),
