        ...
        //1st Boss Servant
         ...
         .Init("UNP Servant of the Dark Knight",
                new State(
                    ...
                    new State("fight1",
                        ...
                        new Shoot(10, count: 5, shootAngle: 9, projectileIndex: 1, coolDown: 2000),
                        new Shoot(10, count: 1, shootAngle: 9, projectileIndex: 0, coolDown: 500),
                    ...
                    new State("fight2",
                     new Prioritize(
                        ...
                        new Shoot(10, count: 7, shootAngle: 9, projectileIndex: 1, coolDown: 1500),
                        new Shoot(10, count: 3, shootAngle: 9, projectileIndex: 2, coolDown: 1250),
                   ...
                   new State("spawn",
                        new TossObject("UNP Sorcerer of the Unspeakable", 4, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("UNP Sorcerer of the Unspeakable", 4, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("UNP Sorcerer of the Unspeakable", 4, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("UNP Sorcerer of the Unspeakable", 4, 270, coolDown: 9999999, randomToss: false),
                ...
                new Threshold(0.025,
                    ...
                    new ItemLoot("Ghilact Dagger", 0.005)
                )
            )
         ...
         .Init("UNP The Dark Knight",
                new State(
                   ...
                   new State("spawn",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new TossObject("UNP Stone Phantom Knight", 6, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("UNP Stone Phantom Knight", 6, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("UNP Stone Phantom Knight", 6, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("UNP Stone Phantom Knight", 6, 270, coolDown: 9999999, randomToss: false),
                   ...
                   new State("rush3",
                        ...
                        new TossObject("UNP Sorcerer of the Unspeakable", 1, 0, coolDown: 9999999, randomToss: false),
