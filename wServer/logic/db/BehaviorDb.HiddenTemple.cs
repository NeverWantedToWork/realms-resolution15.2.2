        ...
        .Init("Anubis Statue",
              ...
              new MostDamagers(3,
                ...
                new Threshold(0.01,
                 ...
                 new ItemLoot("Wig Week Lockbox", 0.04),
              ...
              .Init("Temple Boss",
                new State(
                   ...
                   new State("mainphase",
                    ...
                    new State("battle",
                        new Wander(0.4),
                        new SpecificHeal(1, 1000, "Self", 3000),
         ...
         .Init("Anubis Test Chest",
                ...
                new ItemLoot("Ring of the Hidden Temple", 0.01),
                new ItemLoot("Enchanted Sandstone Armor", 0.01),
                new ItemLoot("Defender Sword", 0.01),
                new ItemLoot("Robe of Overgrowth", 0.01),
                new ItemLoot("Ancient Stiletto", 0.001),
