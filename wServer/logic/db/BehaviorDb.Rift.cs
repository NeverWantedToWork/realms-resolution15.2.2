    ...
    partial class BehaviorDb
    {
        ...
        .Init("Riv the Heavenly Champion",
                new State(
                   ...
                   new State("ShotgunPhase1",
                    ...
                    new State("ReturnToSpawn1",
                        ...
                        new ReturnToSpawn(once: false, speed: 0.5),
                      ...
                      new State("AgileShotguns",
                        ...
                        new SpecificHeal(1, 1250, "Self", coolDown: 1000),
                ...
                new Threshold(0.01,
                    ...
                    new ItemLoot("Sheath of the Holy Revival", 0.01),
                    new ItemLoot("Spectrum Robe", 0.02),
                    new ItemLoot("Eternity Armor", 0.02),
                    new ItemLoot("Mayhem Lockbox", 0.05),
                    new ItemLoot("Mayhem Lockbox Key", 0.055)
                )
            )
        ...
        .Init("HR Heavenly Priest",
            new State(
                ...
                new SpecificHeal(1, 250, "Self", coolDown: 1250),
                new State("fight",
                    new Wander(0.2),
