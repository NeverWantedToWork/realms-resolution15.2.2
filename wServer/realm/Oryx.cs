...
namespace wServer.realm
{
    ...
    internal class Oryx : IDisposable
    {
        ...
        private readonly List<Tuple<string, ISetPiece>> events = new List<Tuple<string, ISetPiece>>
        {
            ...
            Tuple.Create("The Cheesehead", (ISetPiece) new Cheesehead()),
                ...
                },
                {
                    WmapTerrain.MidSand, Tuple.Create(
                        300, new[]
                        {
                            ...
                            Tuple.Create("Large Sor Crystal", 0.01),
                        })
                },
                {
                    WmapTerrain.HighPlains, Tuple.Create(
                        300, new[]
                        {
                            ...
                            Tuple.Create("Undead Dwarf God", 0.3),
                ...
                },
                {
                    WmapTerrain.HighForest, Tuple.Create(
                        300, new[]
                        {
                            ...
                            Tuple.Create("Large Sor Crystal", 0.05),
                        })
                },
                {
                    WmapTerrain.HighSand, Tuple.Create(
                        250, new[]
                        {
                            ...
                            Tuple.Create("Beer God", 0.05),
                            Tuple.Create("Flamer King", 0.2),
                            Tuple.Create("Large Sor Crystal", 0.5),
                        })
                },
                {
                    ...
                    200, new []
                    {
                        ...
                        Tuple.Create("Lucky Ent God", 0.001),
                        Tuple.Create("Lucky Djinn", 0.001),
        ...
        public bool CheckFinalQuests()
        {
            if (CountEnemies(
                ...
                "Skull Shrine", "Cube God", "Grand Sphinx", "Hermit God", "Ghost Ship", "The Cheesehead") != 0) return false;
            RealmClosed = true;
            return true;
        }
        ...
        public void InitCloseRealm()
        {
            ...
            {
                SendMsg(i, "MY MINIONS HAVE FAILED ME!", "#Oryx the Mad God");
                SendMsg(i, "BUT, I HAVE CLOSED THIS REALM!", "#Oryx the Mad God");
        ...
        private static readonly Tuple<string, TauntData>[] criticalEnemies =
        {
            ...
            Tuple.Create("Red Demon", new TauntData
            {
                ...
                final = new[]
                {
                    ...
                    "The ultimate Red Demon can't be beaten!"
                }
            }),
            Tuple.Create("Skull Shrine", new TauntData
            {
                ...
                killed = new[]
                {
                    ...
                    "I can't stand to see, {PLAYER}, kill my Skull Shrine!"
                }
            }),
             ...
             Tuple.Create("The Cheesehead", new TauntData
            {
                spawn = new[]
                {
                    "The great cheese is here! Show them!"
                },
                 killed = new[]
                {
                    "They sure did show us..."
                }
            }),
             ...
             Tuple.Create("Hermit God", new TauntData
            {
                spawn = new[]
                {
                    "The Phantom has been released from the ruins!",
                    "The 4 Elements never have reunited in this way?"
                },
                 killed = new[]
                {
                    "{PLAYER}, why would you destroy the beautiful phantom!?",
                    "{PLAYER}, shouldn't have been this strong!"
                }
            }),
            Tuple.Create("Ghost Ship", new TauntData
            {
                spawn = new[]
                {
                    ...
                    "The Ghost Ship I have summoned already has it's cannonballs ready to blast you uglies away!"
                },
               numberOfEnemies = new[]
                {
                    "The {COUNT} Ghost Ships in the realm will destroy you all, 1 by 1!"
                },
                killed = new[]
                {
