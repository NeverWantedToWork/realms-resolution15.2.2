...
namespace wServer.realm.entities
{
    internal class MerchantLists
    {
        ...
        public static Dictionary<int, Tuple<int, CurrencyType>> prices = new Dictionary<int, Tuple<int, CurrencyType>>
        {
            ...
            {0x5086, new Tuple<int, CurrencyType>(TM ? 1 : 260, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Fun Park key
            ...
            {0x44f6, new Tuple<int, CurrencyType>(TM ? 1 : 300, TM ? CurrencyType.Fame : CurrencyType.Gold)}, //Pork Hut key
            ...
            {0x5182, new Tuple<int, CurrencyType>(TM ? 1 : 800, TM ? CurrencyType.Fame : CurrencyType.Fame)},
            ...
            {0x514a, new Tuple<int, CurrencyType>(TM ? 1 : 3, TM ? CurrencyType.Fame : CurrencyType.FortuneTokens)},
            {0x5187, new Tuple<int, CurrencyType>(TM ? 1 : 4, TM ? CurrencyType.Fame : CurrencyType.FortuneTokens)},
            {0x5188, new Tuple<int, CurrencyType>(TM ? 1 : 2, TM ? CurrencyType.Fame : CurrencyType.FortuneTokens)},
            {0x5186, new Tuple<int, CurrencyType>(TM ? 1 : 5, TM ? CurrencyType.Fame : CurrencyType.FortuneTokens)},
        ...
        public static int[] store10List = { 0x5186, 0x5187, 0x5188, 0x514a };
        ...
        public static int[] store1List =
        {
            ...
            0x70b, 0x70a, 0x705, 0x701, 0x2290, 0x1855, 0x1669, 0x5086, 0x199e, 0x5149, 0x5121,
            0x5050, 0x44f6, 0x45dc, 0x46fb 
        };
        ...
        // rings
        public static int[] store9List = { 0x5172, 0x5173, 0x5174, 0x5175, 0x5176, 0x5182 };
