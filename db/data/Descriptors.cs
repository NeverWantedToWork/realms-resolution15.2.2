...
public class Item : IFeedable
{
    ...
    public Item(ushort type, XElement elem)
    {
        try
        {
            ...
            Enchantable = elem.Element("Enchantable") != null;
            Enchanted = elem.Element("Enchanted") != null;
            Legendary = elem.Element("Legendary") != null;
            Task = elem.Element("Task") != null;
            ActiveTask = elem.Element("ActiveTask") != null;
            Fabled = elem.Element("Fabled") != null;
            Outfit = elem.Element("Outfit") != null;
            Rare = elem.Element("Rare") != null;
            EnchantMaterial = elem.Element("EnchantMaterial") != null;
            Enchanter = elem.Element("Enchanter") != null;
            Resurrects = elem.Element("Resurrects") != null;
            Resistance = elem.Element("Resistance") != null;
            CResistance = elem.Element("CResistance") != null;
            DResistance = elem.Element("DResistance") != null;
            MResistance = elem.Element("MResistance") != null;
            AResistance = elem.Element("AResistance") != null;
            PResistance = elem.Element("PResistance") != null;
            EException = elem.Element("EException") != null;
            UnochAbility = elem.Element("UnochAbility") != null;
    ...
    public bool EnchantMaterial { get; private set; }
    public bool Enchantable { get; private set; }
    public bool Enchanted { get; private set; }
    public bool Legendary { get; private set; }
    public bool Enchanter { get; private set; }
    public bool Task { get; private set; }
    public bool ActiveTask { get; private set; }
    public bool Fabled { get; private set; }
    public bool Outfit { get; private set; }
    public bool Rare { get; private set; }
    public float Cooldown { get; private set; }
    public bool Resurrects { get; private set; }
    public bool Resistance { get; private set; }
    public bool CResistance { get; private set; }
    public bool DResistance { get; private set; }
    public bool UnochAbility { get; private set; }
    public bool MResistance { get; private set; }
    public bool AResistance { get; private set; }
    public bool PResistance { get; private set; }
    public bool EException { get; private set; }
